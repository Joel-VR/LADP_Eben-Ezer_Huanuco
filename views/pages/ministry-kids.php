...
$ministry = db_find_by('ministry_content', 'slug', 'ministerio-ninos');
$pageTitle = $ministry['title'] ?? 'Ministerio de Niños';
$pageDesc = $ministry['description'] ?? 'Enseñanza bíblica y acompañamiento para la niñez';
