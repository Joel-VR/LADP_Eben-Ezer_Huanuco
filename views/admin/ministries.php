    ...
    <div style="display:grid; grid-template-columns: 250px 1fr; gap: 20px;">
        ...
        <div class="card">
            ...
            <form method="POST">
                ...
                <textarea id="photos" name="photos" placeholder="assets/images/ministerios/jovenes/foto1.jpg"><?= htmlspecialchars($ministry['photos'] ?? '') ?></textarea>
                            ...
                            <?php foreach ($ministry['portfolio_items'] as $i => $item): ?>
                                <div class="portfolio-item" style="border: 1px solid #ddd; padding: 12px; border-radius: 6px; margin-bottom: 12px;">
                                    <div style="display: grid; gap: 10px; margin-bottom: 10px;">
                                        ...
                                        <input type="text" name="portfolio_images[]" placeholder="URL de la imagen (ej: assets/images/portfolio/design1.jpg)" value="<?= htmlspecialchars($item['image_url'] ?? '') ?>" style="width:100%;">
                    ...
                    function addPortfolio() {
                        ...
                        item.innerHTML = `
                            <div style="display: grid; gap: 10px; margin-bottom: 10px;">
                                ...
                                <input type="text" name="portfolio_images[]" placeholder="URL de la imagen (ej: assets/images/portfolio/design1.jpg)" style="width:100%;">
