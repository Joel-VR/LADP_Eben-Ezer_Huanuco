...
$ministry = db_find_by('ministry_content', 'slug', 'ministerio-familia');
$pageTitle = $ministry['title'] ?? 'Ministerio de Familia';
$pageDesc = $ministry['description'] ?? 'Fortalecimiento de hogares y relaciones saludables';
