...
$ministry = db_find_by('ministry_content', 'slug', 'direccion-misiones');
$pageTitle = $ministry['title'] ?? 'Dirección de Misiones';
$pageDesc = $ministry['description'] ?? 'Expansión, anexos y apoyo misionero';
