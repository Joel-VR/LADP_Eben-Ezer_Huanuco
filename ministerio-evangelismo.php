...
$ministry = db_find_by('ministry_content', 'slug', 'ministerio-evangelismo');
$pageTitle = $ministry['title'] ?? 'Ministerio de Evangelismo';
$pageDesc = $ministry['description'] ?? 'Alcance y proclamación del evangelio';
